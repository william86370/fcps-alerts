...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Initialize Parse.
        Parse.setApplicationId("AhMwW1ppLL40MGnNAGZaRYsbrV2XCwo7O7pjwCfC",
            clientKey: "OwXeO9by5dYGMmL4sPIH1vycjJH9Yh8XgUf4Lchp")
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.arc.FCPSAlert.FCPS_Alert" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.urlForResource("FCPS_Alert", withExtension: "momd")!
