...
public class PullToRefreshView: UIView {
    ...
    public convenience init(options: PullToRefreshOption, frame: CGRect, refreshCompletion :(() -> ())) {
        ...
        self.arrow.image = UIImage(named: PullToRefreshConst.imageName, in: Bundle(for: type(of: type), compatibleWith: nil))
    ...
    public override func observeValue(forKeyPath keyPath: String?, of object: AnyObject?, change: [NSKeyValueChangeKey : AnyObject]?, context: UnsafeMutablePointer<()>?) {
